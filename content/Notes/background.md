...
overview: 
why to learn, 
	background(my past and current situation)
	 future aspiration
what to learn, 
...
## Background: 
I have been a software developer since 2018, I started my career with an internship in Angular2. 
Then slowly I moved to the backend side of thing, first exploring a bit of backend along side with frontend and later shifted full time to backed in golang.
...
So, I am still a software developer with little to no knowledge of the underlying system.
so this time, I have again mustered up some courage and will try to make this long awaited task from my checklist.
